...
/**
 * struct radius_server - RADIUS server information for RADIUS client
 *
...
/**
 * struct radius_servers - RADIUS servers for RADIUS client
 */
struct radius_servers {
	/**
	 * auth_servers - RADIUS Authentication servers in priority order
	 */
	struct radius_server *auth_servers;
	 ...
	 */
	struct radius_server *acct_servers;
