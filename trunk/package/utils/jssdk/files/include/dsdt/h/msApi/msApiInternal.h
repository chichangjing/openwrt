...
#define GT_USE_SIMPLE_PORT_MAPPING
...
#define G1_DEV_88E6321_AVB_FAMILY    (DEV_88E6321 )
#define DEV_88E6321_NO_AVB_FAMILY   0
#define G1_DEV_88E6321_NO_AVB_FAMILY    (DEV_88E6320)
...
#define G1_DEV_AVB_FAMILY      (G1_DEV_88E6321_AVB_FAMILY)

#define DEV_TCAM_FAMILY    (DEV_88E6352_AVB_FAMILY)
#define G1_DEV_TCAM_FAMILY      (G1_DEV_88E6321_AVB_FAMILY)
...
#define G1_DEV_DEVICE_INT_TYPE3    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )    

#define DEV_WATCHDOG_EVENT    ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_WATCHDOG_EVENT    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
...
#define G1_DEV_DEV_PHY_INTERRUPT    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )    /* device interrupt includes phy int */

#define DEV_AVB_INTERRUPT      ( DEV_88E6165_FAMILY | DEV_88E6351_FAMILY| DEV_88E6352_FAMILY )
#define G1_DEV_AVB_INTERRUPT      ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )

#define DEV_AUTO_REFRESH_LOCKED    ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY| DEV_88E6352_FAMILY )
#define G1_DEV_AUTO_REFRESH_LOCKED    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
...
#define DEV_PPU_PHY_ACCESS_RES    ( DEV_88E6097_FAMILY | G1_DEV_88E6321_FAMILY )
#define G1_DEV_PPU_PHY_ACCESS_RES    0

#define DEV_PPU_READ_ONLY    ( DEV_88E6165_FAMILY | DEV_88E6351_FAMILY| DEV_88E6352_FAMILY )
#define G1_DEV_PPU_READ_ONLY     (G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY)
...
#define G1_DEV_ATU_LIMIT    (G1_DEV_88E6321_FAMILY)

#define DEV_ATU_LIMIT_READ    ( DEV_88E6351_FAMILY| DEV_88E6352_FAMILY )
#define G1_DEV_ATU_LIMIT_READ    (G1_DEV_88E6321_FAMILY)
...
#define G1_DEV_DBNUM_4096    (G1_DEV_88E6321_FAMILY) 
...
#define DEV_STATIC_ADDR    ( DEV_88E6060 | DEV_88E6021 | DEV_FF_EG | DEV_FF_HG | DEV_88E6052 | DEV_88E6063 | \
      ...
      DEV_88E6165_FAMILY | DEV_88E6351_FAMILY| DEV_88E6352_FAMILY )
#define G1_DEV_STATIC_ADDR    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY)
...
#define G1_DEV_HEADER    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
...
#define G1_DEV_QoS    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
...
#define G1_DEV_QoS_WEIGHT    (G1_DEV_88E6321_AVB_FAMILY)
...
#define DEV_802_1Q    ( DEV_88E6021 | DEV_88E6063 | DEV_FH_VPN |     \
              ...
              DEV_88E6165_FAMILY | DEV_88E6351_FAMILY| DEV_88E6352_FAMILY )
#define G1_DEV_802_1Q    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
...
#define DEV_802_1W    ( DEV_88E6183 | DEV_88E6093 | DEV_88E6095 |     \
              ...
              DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_802_1W    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
...
#define DEV_RMON    ( DEV_88E6021 | DEV_88E6063 | DEV_FH_VPN |     \
              ...
              DEV_88E6165_FAMILY | DEV_88E6351_FAMILY| DEV_88E6352_FAMILY ) 
#define G1_DEV_RMON    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY ) 
...
#define DEV_RMON_TYPE_3     \
        ( DEV_88E6093 | DEV_88E6095 | DEV_88E6092 |     \
          ...
          DEV_88E6097_FAMILY |        \
          DEV_88E6165_FAMILY | DEV_88E6351_FAMILY| DEV_88E6352_FAMILY )
#define G1_DEV_RMON_TYPE_3 ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
...
#define G1_DEV_RMON_REALTIME_SUPPORT    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY)
...
#define DEV_EGRESS_RATE_KBPS    \
    ( DEV_FF_HG | DEV_88E6063 | DEV_FH_VPN |            \
      ...
      DEV_88E6097_FAMILY | DEV_88E6165_FAMILY |         \
      DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_EGRESS_RATE_KBPS    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY)
...
#define DEV_PCS_LINK    ( DEV_88E6093 | DEV_88E6095_FAMILY |     \
              ...
              DEV_88E6165_FAMILY | DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_PCS_LINK    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
...
#define DEV_GIGABIT_SWITCH        \
        ( DEV_88E6181 | DEV_88E6183 | DEV_88E6093 |     \
          ...
          DEV_88E6097_FAMILY | DEV_88E6165_FAMILY |     \
          DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_GIGABIT_SWITCH        (G1_DEV_88E6321_AVB_FAMILY)
...
#define DEV_GIGABIT_MANAGED_SWITCH    \
        ( DEV_88E6183 | DEV_88E6093 | \
          ...
          DEV_88E6097_FAMILY | DEV_88E6165_FAMILY |     \
          DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_GIGABIT_MANAGED_SWITCH    (G1_DEV_88E6321_AVB_FAMILY)
...
#define DEV_CROSS_CHIP_PORT_VLAN    \
    ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY |    \
      DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_CROSS_CHIP_PORT_VLAN    (G1_DEV_88E6321_AVB_FAMILY)

#define DEV_TRUNK    ( DEV_88E6095_FAMILY | DEV_88E6185_FAMILY |    \
              DEV_88E6097_FAMILY | DEV_88E6165_FAMILY |    \
              DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_TRUNK    (G1_DEV_88E6321_AVB_FAMILY)
...
#define DEV_TRUNK_NEW_ID_LOCATION    \
    ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY |     \
      DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_TRUNK_NEW_ID_LOCATION     (G1_DEV_88E6321_AVB_FAMILY)
...
#define DEV_STACKING    \
    ( DEV_88E6095 | DEV_88E6185 | DEV_88E6108 |        \
      DEV_88E6097_FAMILY | DEV_88E6165_FAMILY |        \
      DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_STACKING    (G1_DEV_88E6321_AVB_FAMILY)
...
#define DEV_FLOW_CTRL_DELAY        \
    ( DEV_88E6095_FAMILY | DEV_88E6185_FAMILY |        \
      DEV_88E6097_FAMILY | DEV_88E6165_FAMILY |        \
      DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_FLOW_CTRL_DELAY        (G1_DEV_88E6321_AVB_FAMILY)
...
#define G1_DEV_OUT_Q_SIZE        \
    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
#define DEV_OUT_Q_SIZE_1        \
		(0)
#define G1_DEV_OUT_Q_SIZE_1        \
		( G1_DEV_88E6321_FAMILY )
...
#define DEV_FID_REG        \
    ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_FID_REG    (G1_DEV_88E6321_AVB_FAMILY)

#define DEV_FRAME_TO_REGISTER    \
    ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_FRAME_TO_REGISTER   (G1_DEV_88E6321_AVB_FAMILY)

#define DEV_RMU_MODE    ( DEV_88E6165_FAMILY | DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_RMU_MODE  (G1_DEV_88E6321_AVB_FAMILY)

#define DEV_DA_CHECK    ( DEV_88E6165_FAMILY | DEV_88E6351_FAMILY | DEV_88E6352_FAMILY )
#define G1_DEV_DA_CHECK  (G1_DEV_88E6321_AVB_FAMILY)

#define DEV_DA_CHECK_1    ( DEV_88E6352_FAMILY )
#define G1_DEV_DA_CHECK_1  (G1_DEV_88E6321_AVB_FAMILY)

#define DEV_HEADER_TYPE    (DEV_88E6352_FAMILY)
#define G1_DEV_HEADER_TYPE  (G1_DEV_88E6321_AVB_FAMILY)
...
#define G1_DEV_DEF_QPRI   ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
...
#define G1_DEV_PTP_2        ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
#define DEV_TAI        ( DEV_AVB_FAMILY )
#define G1_DEV_TAI    \
    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
#define DEV_TAI_MULTI_PTP_SYNC    ( DEV_AVB_FAMILY)
#define G1_DEV_TAI_MULTI_PTP_SYNC    (G1_DEV_88E6321_AVB_FAMILY)
#define DEV_TAI_EXT_CLK    ( DEV_88E6352_AVB_FAMILY)
#define G1_DEV_TAI_EXT_CLK    (G1_DEV_88E6321_AVB_FAMILY)
#define DEV_ARRV_TS_MODE    ( DEV_88E6352_AVB_FAMILY)
#define G1_DEV_ARRV_TS_MODE    (G1_DEV_88E6321_AVB_FAMILY)
#define DEV_TAI_TRIG_GEN   0
#define G1_DEV_TAI_TRIG_GEN    (G1_DEV_88E6321_AVB_FAMILY)
#define DEV_RMU_PAGE2   0
#define G1_DEV_RMU_PAGE2    (G1_DEV_88E6321_AVB_FAMILY)
#define DEV_QUEUE_CONTROL   0
#define G1_DEV_QUEUE_CONTROL    (G1_DEV_88E6321_AVB_FAMILY)
#define DEV_DEBUG_COUNTER   0
#define G1_DEV_DEBUG_COUNTER    (G1_DEV_88E6321_AVB_FAMILY)
#define DEV_CUT_THROUGH   0
#define G1_DEV_CUT_THROUGH    (G1_DEV_88E6321_AVB_FAMILY)
...
#define G1_DEV_QAV_ENABLE    ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
#define DEV_QAV_TIME_AWARE_BLK        ( 0 )
#define G1_DEV_QAV_TIME_AWARE_BLK    ( G1_DEV_88E6321_FAMILY )
...
#define G1_DEV_RGMII_TIMING        ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
...
#define G1_DEV_LED_CFG            ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
#define DEV_LED_CFG_1        ( DEV_88E6352_FAMILY )
#define G1_DEV_LED_CFG_1            ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
...
#define G1_DEV_CLK_125            ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
...
#define G1_DEV_SCRATCH_MISC_CTRL        ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )

#define DEV_SCRATCH_MISC_BYTE        ( DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_SCRATCH_MISC_BYTE        ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
#define DEV_SCRATCH_PWR_VOLT_REGUL_CTRL        ( DEV_88E6352_FAMILY)
#define G1_DEV_SCRATCH_PWR_VOLT_REGUL_CTRL     ( G1_DEV_88E6321_FAMILY )
#define DEV_SCRATCH_EEE_REG_SPACE         ( DEV_88E6352_FAMILY)
#define G1_DEV_SCRATCH_EEE_REG_SPACE      ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
#define DEV_SCRATCH_GPIO_PORT_STALL_VECT    ( DEV_88E6352_FAMILY)
#define G1_DEV_SCRATCH_GPIO_PORT_STALL_VECT ( G1_DEV_88E6321_FAMILY )
#define DEV_SCRATCH_EEE_RECV_ST_COUNTER     ( DEV_88E6352_FAMILY)
#define G1_DEV_SCRATCH_EEE_RECV_ST_COUNTER  ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
#define DEV_SCRATCH_EEE_TRSM_ST_COUNTER     ( DEV_88E6352_FAMILY)
#define G1_DEV_SCRATCH_EEE_TRSM_ST_COUNTER  ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
#define DEV_SCRATCH_EEE_ST_REG     ( DEV_88E6352_FAMILY)
#define G1_DEV_SCRATCH_EEE_ST_REG  ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
#define DEV_SCRATCH_GPIO_CTRL     ( DEV_88E6351_FAMILY | DEV_88E6352_FAMILY)
#define G1_DEV_SCRATCH_GPIO_CTRL  ( G1_DEV_88E6321_FAMILY )
#define DEV_SCRATCH_GPIO_CTRL_1     ( DEV_88E6352_FAMILY)
#define G1_DEV_SCRATCH_GPIO_CTRL_1  ( G1_DEV_88E6321_FAMILY )
#define DEV_SCRATCH_GPIO_SMI_CTRL     ( 0)
#define G1_DEV_SCRATCH_GPIO_SMI_CTRL  ( G1_DEV_88E6321_FAMILY )
#define DEV_SCRATCH_CFG_READ     ( DEV_88E6351_FAMILY |DEV_88E6352_FAMILY)
#define G1_DEV_SCRATCH_CFG_READ  ( G1_DEV_88E6321_FAMILY )
#define DEV_SCRATCH_CFG_READ_PAD_DRV     ( DEV_88E6352_FAMILY)
#define G1_DEV_SCRATCH_CFG_READ_PAD_DRV  ( G1_DEV_88E6321_FAMILY )
...
#define G1_DEV_EEPROM            ( G1_DEV_88E6351_FAMILY | G1_DEV_88E6321_FAMILY)

#define DEV_RMGMT        (DEV_88E6351_FAMILY | DEV_88E6352_FAMILY| DEV_88E6097_FAMILY |DEV_88E6165_FAMILY)
#define G1_DEV_RMGMT        ( G1_DEV_FE_AVB_FAMILY | G1_DEV_88E6321_FAMILY )
...
#define G1_DEV_TCAM        (G1_DEV_88E6321_AVB_FAMILY)
