...
typedef enum
{
    ...
    GT_88E6320    = 0x125, /* Pearl */
    GT_88E6310    = 0x310,  /* Pearl */
    GT_88E6321    = 0x320  /* Pearl */
...
typedef struct _GT_AVB_CONFIG
{
    ...
    } avbPri, legacyPri; 	/**< INPUT param if set, OUTPUT param if get */
    ...
    struct {
      unsigned short resv0:2;	/* */
      unsigned short avbOverride:1;	/* */
      unsigned short filterbadAvb:1;	/* */
      unsigned short avbTunnel:1;	/* */
      unsigned short resv1:5;	/* */
      unsigned short avbHiPolicy:3;	/* */
      unsigned short avbLowPolicy:3;	/* */
    } avbPolicy;	/**< INPUT param if set, OUTPUT param if get */
} GT_AVB_CONFIG;
