...
static sw_error_t _mv88e6097_mib_info_get(a_uint32_t dev_id, fal_port_t port_id, fal_mib_info_t *mib_info)
{
    sw_error_t rv = SW_OK;
	a_uint32_t hport_id;
...
sw_error_t mv88e6097_mib_info_get(a_uint32_t dev_id, fal_port_t port_id, fal_mib_info_t *mib_info)
{
    ...
    HSL_API_LOCK;
    rv = _mv88e6097_mib_info_get(dev_id, port_id, mib_info);
    HSL_API_UNLOCK;
    return rv;
}
...
sw_error_t mv88e6097_mib_info_clear(a_uint32_t dev_id, fal_port_t port_id)
{
    ...
    HSL_API_LOCK;
    rv = _mv88e6097_mib_info_clear(dev_id, port_id);
    HSL_API_UNLOCK;
    return rv;
}

#if 0
sw_error_t mv88e6097_mib_test_show(a_uint32_t dev_id, fal_port_t port_id)
{
	fal_mib_info_t mibinfo;

	SW_RTN_ON_ERROR(mv88e6097_mib_info_get(dev_id, port_id, &mibinfo));
...
sw_error_t mv88e6097_mib_init(a_uint32_t dev_id)
{
    ...
    p_api->mib_info_get = mv88e6097_mib_info_get;
    p_api->mib_info_clear = mv88e6097_mib_info_clear;
