...
********************************************************************************
* gtHwIfDrv.h - Management hardware interface driver.
*
* DESCRIPTION:
*       Enable management hw access to GT devices via selected hardware
*       interfaces.
*
* DEPENDENCIES:
*       None.
...
)
{
    ...
    {
        rc = gtI2cMgmtReadRegister(devId.i2cBaseAddr, regAddr | 0x80000000,
                                     data);
    }
    else
    {
