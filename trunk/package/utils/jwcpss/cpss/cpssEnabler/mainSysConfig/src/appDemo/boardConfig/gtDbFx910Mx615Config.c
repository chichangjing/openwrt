...
********************************************************************************
* gtDbFx900Mx615Config.c
*
* DESCRIPTION:
*       Initialization functions for the DB-FX910-MX615-48F4GS boards.
*
* DEPENDENCIES:
*       None.
*
...
)
{
    ...
    /* External Flow Dram configurations  */
    localPpPh1Config.flowDramCfg.dramSize               = CPSS_DRAM_16MB_E;
    ...
    localPpPh1Config.flowDramCfg.mrs                      = 0x51;/* 0x31;*/
    localPpPh1Config.flowDramCfg.emrs                     = 0x0; /* 0x2; */
    localPpPh1Config.flowDramCfg.dramTiming.tdqss         = 0x0;
    localPpPh1Config.flowDramCfg.dramTiming.trcd          = 0x5; /* 0x4; */
    localPpPh1Config.flowDramCfg.dramTiming.trp           = 0x2;
    localPpPh1Config.flowDramCfg.dramTiming.twr           = 0x2; /* 0x1; */
    localPpPh1Config.flowDramCfg.dramTiming.twtr          = 0x3;
    localPpPh1Config.flowDramCfg.dramTiming.tras          = 0xA; /* 0x7; */
    localPpPh1Config.flowDramCfg.dramTiming.trrd          = 0x1; /* 0x0; */
    localPpPh1Config.flowDramCfg.dramTiming.tmrd          = 0x0;
    localPpPh1Config.flowDramCfg.dramTiming.trfc          = 0x9; /* 0x8; */
    ...
    if(localPpPh1Config.deviceId == CPSS_98MX618_CNS)
    {
        /* External buffer Dram configurations  */
        localPpPh1Config.bufferDramCfg.mrs                      = 0x41;/*0x51;*/
        localPpPh1Config.bufferDramCfg.emrs                     = 0x2;/*0x0;*/
        localPpPh1Config.bufferDramCfg.dramTiming.trcd          = 0x4;/*0x5;*/
        localPpPh1Config.bufferDramCfg.dramTiming.twtr          = 0x1;/*0x3;*/

        localPpPh1Config.bufferDramCfg.dramTiming.trfc          = 0x7;/*0x9;*/
        localPpPh1Config.bufferDramCfg.dramTiming.rd2wrDelay    = 0x1;/*0x0;*/

        localPpPh1Config.bufferDramCfg.dramTiming.writeCount    = 0x7;/*0x3;*/
        localPpPh1Config.bufferDramCfg.dramTiming.readCount     = 0x7;/*0x3;*/

        localPpPh1Config.bufferDramCfg.trCdWr                   = 0x1;/*0x0;*/

        /* Set the refresh count according to the BD frequency. */
        localPpPh1Config.bufferDramCfg.dramFrequency = CPSS_DRAM_FREQ_250_MHZ_E;
        localPpPh1Config.bufferDramCfg.refreshCounter           = 0x73A;/*0x6D0;*/

        /* Flow Dram configurations  Samsung           */
        localPpPh1Config.flowDramCfg.mrs                      = 0x31;/*0x51;*/
        localPpPh1Config.flowDramCfg.emrs                     = 0x2;/*0x0;*/
        localPpPh1Config.flowDramCfg.dramTiming.trcd          = 0x3;/*0x5;*/
        localPpPh1Config.flowDramCfg.dramTiming.trp           = 0x1;/*0x2;*/
        localPpPh1Config.flowDramCfg.dramTiming.tras          = 0x6;/*0xA;*/
        localPpPh1Config.flowDramCfg.dramTiming.trfc          = 0xB;/*0x9;*/
        localPpPh1Config.flowDramCfg.dramTiming.writeCount    = 0x7;/*0x3;*/
        localPpPh1Config.flowDramCfg.dramTiming.readCount     = 0x7;/*0x3;*/
        localPpPh1Config.flowDramCfg.dramFrequency = CPSS_DRAM_FREQ_200_MHZ_E;
        localPpPh1Config.flowDramCfg.refreshCounter           = 0x5B4;/*0xE70;*/
    }


    /* WSRAM config */
    localPpPh1Config.sramsCfg[0].sramSize               = CPSS_SRAM_SIZE_4MB_E;
    localPpPh1Config.sramsCfg[0].sramType               = CPSS_SRAM_TYPE_WIDE_E;
    ...
    localPpPh1Config.sramsCfg[1].sramFrequency  = CPSS_SRAM_FREQ_166_MHZ_E;
    localPpPh1Config.sramsCfg[1].sramRate       = CPSS_SRAM_RATE_DDR_E;
    localPpPh1Config.sramsCfg[1].externalMemory = CPSS_EXTERNAL_MEMORY_0_E;
...
)
{
    ...
    if(appDemoPpConfigList[devIdx].deviceId == CPSS_98MX618_CNS)
    {
        localFaPh1Config.bufferDramCfg.dramFrequency   = CPSS_DRAM_FREQ_250_MHZ_E;
        localFaPh1Config.bufferDramCfg.dramTiming.trcd = 0x4;
        localFaPh1Config.bufferDramCfg.dramTiming.trp  = 0x2;
        localFaPh1Config.bufferDramCfg.dramTiming.twtr = 0x1;
        localFaPh1Config.bufferDramCfg.dramTiming.tras = 0xa;
        localFaPh1Config.bufferDramCfg.dramTiming.trfc = 0x7;
        localFaPh1Config.bufferDramCfg.refreshCounter  = 0x73A;
        localFaPh1Config.bufferDramCfg.trCdWr          = 0x1;
    }
...
/*
            coreSetPortPhyAddr(appDemoPpConfigList[i].devNum,6,0x1e);
            coreSetPortPhyAddr(appDemoPpConfigList[i].devNum,7,0x1f);
*/
...
)
{
    ...
    /* samba's LIF has two search slots*/
    /*libInitParams->lastSearchSlot = 1 ;*/

    /* PCL ID is 6bit large */
    /*libInitParams->maxNumOfPcl = 64 ;*/
...
{
#if 0   /* [SL...][SergiyL] - don't know what to do with this - all is commented out
    GT_U8       i;
    GT_U8       j;
    GT_STATUS   retVal;
    GT_LPORT    lport;    */

    /* Set all phy's to Delay mode. */
    for(i = 0; i < PRV_CPSS_MAX_PP_DEVICES_CNS; i++)
    {
        if(appDemoPpConfigList[i].valid == GT_TRUE)
        {
            ...
            {
                lport = GT_PORT_DEV_2_LPORT(appDemoPpConfigList[i].devNum,j,
                                            appDemoPpConfigList[i].unitNum);

                /* Set to delay mode.   */
                retVal = psmiWritePortPhyRegister(lport,0x14,0xCE2);
                if(retVal != GT_OK)
                {
                    return retVal;
                }
                ...
                /* Phy reset.           */
                retVal = psmiWritePortPhyRegister(lport,0x0,0x9140);
                if(retVal != GT_OK)
                {
                    return retVal;
                }
...
*
* DESCRIPTION:
*       Registeration function for the DB-FX910-MX615-48F4GS board.*
* INPUTS:
*       boardRevId      - The board revision Id.
*
* OUTPUTS:
