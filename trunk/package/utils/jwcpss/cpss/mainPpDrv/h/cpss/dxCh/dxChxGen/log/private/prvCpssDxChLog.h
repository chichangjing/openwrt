...
*       $Revision: 1 $
*******************************************************************************/
#ifndef __prvCpssDxChLogh
#define __prvCpssDxChLogh
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_ETHERTYPE_TABLE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_FDB_LEARN_PRIORITY_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_MEMBER_SELECTION_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_PAIR_READ_WRITE_FORM_ENT);
