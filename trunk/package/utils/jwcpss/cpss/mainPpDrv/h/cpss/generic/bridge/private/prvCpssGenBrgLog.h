...
*       $Revision: 1 $
*******************************************************************************/
#ifndef __prvCpssGenBrgLogh
#define __prvCpssGenBrgLogh
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_BRG_IPM_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_BRG_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_MAP_DECLARE_MAC(CPSS_BRG_SECUR_BREACH_EVENTS_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_BRG_SRC_ID_ASSIGN_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_BRG_TPID_SIZE_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_BRIDGE_INGR_CNTR_MODES_ENT);
PRV_CPSS_LOG_STC_ENUM_MAP_DECLARE_MAC(CPSS_ETHER_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_FDB_ACTION_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_IGMP_SNOOP_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_MAC_ACTION_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_MAC_HASH_FUNC_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_MAC_SECURE_AUTO_LEARN_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_MAP_DECLARE_MAC(CPSS_MAC_VL_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_PORT_ACCEPT_FRAME_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_MAP_DECLARE_MAC(CPSS_PORT_LOCK_CMD_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_STP_STATE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_VLAN_TAG_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_BRG_SECUR_BREACH_DROP_COUNT_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_MAC_ENTRY_EXT_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_MAC_TABLE_CMD_ENT);
PRV_CPSS_LOG_STC_ENUM_MAP_DECLARE_MAC(CPSS_RATE_LIMIT_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_UPD_MSG_TYPE_ENT);
