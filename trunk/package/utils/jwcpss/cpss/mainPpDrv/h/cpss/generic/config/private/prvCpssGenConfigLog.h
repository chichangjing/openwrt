...
*       $Revision: 1 $
*******************************************************************************/
#ifndef __prvCpssGenConfigLogh
#define __prvCpssGenConfigLogh
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_GEN_CFG_HW_DEV_NUM_MODE_ENT);
