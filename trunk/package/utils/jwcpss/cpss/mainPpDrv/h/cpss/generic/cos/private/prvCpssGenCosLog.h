...
*       $Revision: 1 $
*******************************************************************************/
#ifndef __prvCpssGenCosLogh
#define __prvCpssGenCosLogh
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DP_LEVEL_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_MAC_QOS_RESOLVE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_QOS_PORT_TRUST_MODE_ENT);
