...
*       $Revision: 1 $
*******************************************************************************/
#ifndef __prvCpssGenCpssHwInitLogh
#define __prvCpssGenCpssHwInitLogh
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_MAC_SA_LSB_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_PP_INTERFACE_CHANNEL_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_AU_MESSAGE_LENGTH_ENT);
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_LED_CLASS_13_SELECT_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_LED_CLASS_5_SELECT_ENT);
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DRAM_BUS_WIDTH_ENT);
PRV_CPSS_LOG_STC_ENUM_MAP_DECLARE_MAC(CPSS_DRAM_FREQUENCY_ENT);
PRV_CPSS_LOG_STC_ENUM_MAP_DECLARE_MAC(CPSS_DRAM_SIZE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DRAM_SPEED_BIN_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DRAM_TEMPERATURE_ENT);
...
#endif /* __cplusplus */
#endif /* __prvCpssGenCpssHwInitLogh */
