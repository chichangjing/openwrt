...
*       $Revision: 1 $
*******************************************************************************/
#ifndef __prvCpssGenCscdLogh
#define __prvCpssGenCscdLogh
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_CSCD_PORT_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_CSCD_LINK_TYPE_ENT);
