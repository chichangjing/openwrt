...
*       $Revision: 1 $
*******************************************************************************/
#ifndef __prvCpssGenDiagLogh
#define __prvCpssGenDiagLogh
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DIAG_DATA_INTEGRITY_ERROR_CAUSE_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DIAG_DATA_INTEGRITY_ERROR_INJECT_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DIAG_DATA_INTEGRITY_MEM_ERROR_PROTECTION_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DIAG_PP_MEM_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DIAG_PP_REG_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DIAG_TEST_PROFILE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DIAG_DATA_INTEGRITY_TCAM_ARRAY_TYPE_ENT);
