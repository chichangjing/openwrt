...
*       $Revision: 1 $
*******************************************************************************/
#ifndef __prvCpssGenPpTypesLogh
#define __prvCpssGenPpTypesLogh
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_ADJUST_OPERATION_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_COMPARE_OPERATOR_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DIRECTION_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DROP_MODE_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_IP_PROTOCOL_STACK_ENT);
PRV_CPSS_LOG_STC_ENUM_MAP_DECLARE_MAC(CPSS_L4_PROTOCOL_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_L4_PROTOCOL_PORT_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_PACKET_ATTRIBUTE_ASSIGN_PRECEDENCE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_PACKET_CMD_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_UNICAST_MULTICAST_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_INTERFACE_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_PACKET_ATTRIBUTE_ASSIGN_CMD_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_PACKET_ATTRIBUTE_MODIFY_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_MAP_DECLARE_MAC(CPSS_PP_FAMILY_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_MAP_DECLARE_MAC(CPSS_PP_SUB_FAMILY_TYPE_ENT);
