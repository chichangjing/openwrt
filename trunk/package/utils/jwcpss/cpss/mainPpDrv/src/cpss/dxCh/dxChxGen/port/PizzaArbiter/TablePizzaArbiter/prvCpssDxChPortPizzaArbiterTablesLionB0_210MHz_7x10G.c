...
CPSS_DXCH_PORT_SPEED_TO_SLICE_NUM_STC portSpeed2SliceNumListLionB0_240Mhz_7x10G[] = 
{     /* port speed        ,     slices N */
...
const CPSS_DXCH_PORT_PIZZA_PORTGROUP_SPEED_TO_SLICENUM_STC prvPortGroupPortSpeed2SliceNumLionB0_240Mhz_7x10G = 
{
    /* 12 */
    {
         { 0 , &portSpeed2SliceNumListLionB0_240Mhz_7x10G[0] }
        ,{ 1 , &portSpeed2SliceNumListLionB0_240Mhz_7x10G[0] }
        ,{ 2 , &portSpeed2SliceNumListLionB0_240Mhz_7x10G[0] }
        ,{ 3 , &portSpeed2SliceNumListLionB0_240Mhz_7x10G[0] }
        ,{ 4 , &portSpeed2SliceNumListLionB0_240Mhz_7x10G[0] }
        ,{ 5 , &portSpeed2SliceNumListLionB0_240Mhz_7x10G[0] }
        ,{ 6 , &portSpeed2SliceNumListLionB0_240Mhz_7x10G[0] }
