...
CPSS_DXCH_PORT_SPEED_TO_SLICE_NUM_STC portSpeed2SliceNumListLionB0_270Mhz_9x10G[] = 
{     /* port speed        ,     slices N */
...
const CPSS_DXCH_PORT_PIZZA_PORTGROUP_SPEED_TO_SLICENUM_STC prvPortGroupPortSpeed2SliceNumLionB0_270Mhz_9x10G = 
{
    /* 12 */
    {
