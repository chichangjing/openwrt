...
#include "../applicationIf/SerdesRxOptAppIf.h"

#define CAL_CFG_REG_OFFSET      (0xA)
#define TRANSMITTER_REG1_OFFSET (0x15)
#define SQL_CFG_REG_OFFSET      (0x1E)
#define FFE_CFG_REG_OFFSET      (0x23)
#define DFE_CFG_REG_OFFSET      (0x26)
#define RESET_CFG_REG_OFFSET    (0x5B)
#define PHY_TEST_REG0_OFFSET    (0x5E)
#define PHY_TEST_REG1_OFFSET    (0x5F)
#define PHY_TEST_DATA5_OFFSET   (0x65)
#define PRBS_ERROR_MSB_OFFSET   (0x69)
#define PRBS_ERROR_LSB_OFFSET   (0x6A)
#define PRBS_COUNTER_OFFSET     (0x68)
...
static GT_U32 getErrors(GT_U8 devNum, GT_U32 portGroup, GT_U32 laneNum)
{
    ...
    genRegisterGet(devNum, portGroup,baseAddr + PHY_TEST_REG1_OFFSET, &tmp, 0);
    ...
    genRegisterGet(devNum, portGroup, baseAddr + PRBS_ERROR_MSB_OFFSET, &tmp, 0); 
    genRegisterGet(devNum, portGroup, baseAddr + PRBS_ERROR_LSB_OFFSET, &errCnt1, 0);
    errCnt1 = tmp + 0x1000 * errCnt1; 
    
    genRegisterGet(devNum, portGroup, baseAddr + PRBS_ERROR_MSB_OFFSET, &tmp, 0);
    genRegisterGet(devNum, portGroup, baseAddr + PRBS_ERROR_LSB_OFFSET, &errCnt2, 0);          
...
void  milos4SerdesFuncRegistration(MV_ACCESS_FUNCS *accIf)
{
