#
# Golden Mode library for Bobcat2B0
#
# Please note: 4th and 5th parameter of build sh changed:
#	4th parameter: chip_name (BC2)
#   5th parameter: mode { RELEASE | DEBUG | PURIFY }
#
# Example:
#   Build.sh Linux i386 LinuxWM BC2 DEBUG BC2_GM $OBJS_DIR
#


export GM_ROOT=$GM_PATH
export GM_PROJECT=BC2BGm
export GM_KERNEL_DIR=verifierKernel/Verifier_gm_krnl_3_3_0 
export GM_KERNEL_RELEASE_DIR=verifierKernel
export GM_SILICON=BC2B
export GM=gm
