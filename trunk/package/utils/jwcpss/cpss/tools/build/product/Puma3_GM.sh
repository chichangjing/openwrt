#
# Golden Mode library for Puma3
#
# Please note: 4th and 5th parameter of build sh changed:
#	4th parameter: chip_name (98EX24X)
#   5th parameter: mode { RELEASE | DEBUG | PURIFY }
#
# Example:
#   Build.sh Linux i386 LinuxWM 98EX24X DEBUG Puma3_GM $OBJS_DIR
#

export GM_ROOT=$GM_PATH
export GM_PROJECT=puma3Gm
export GM_KERNEL_DIR=verifierKernel
export GM_SILICON=Puma3
export GM=gm
