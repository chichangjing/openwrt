...
export USE_MARVELL_V7SFT=TRUE

#COMP_PREFIX=arm-marvell-linux-gnueabi-
#XCOMP_ROOT_PATH_SUFFIX=arm-marvell-linux-gnueabi/libc      

COMP_PREFIX=arm-openwrt-linux-muslgnueabi-
XCOMP_ROOT_PATH_SUFFIX=arm-openwrt-linux-muslgnueabi/libc     

export TOOL=gnu
export TOOL_FAMILY=gnu
export TOOLKIT_MAKE_RULES=marvell_v7sft
