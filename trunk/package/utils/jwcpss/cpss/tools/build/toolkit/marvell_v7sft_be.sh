...
export USE_MARVELL_V7SFT_BE=TRUE
  
COMP_PREFIX=armeb-marvell-linux-gnueabi-
XCOMP_ROOT_PATH_SUFFIX=armeb-marvell-linux-gnueabi/libc

export TOOL=gnu
export TOOL_FAMILY=gnu
export TOOLKIT_MAKE_RULES=marvell_v7sft_be
