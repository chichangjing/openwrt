#
# Make target definitions for Microsoft Visual C++ 6
#
...
$(OBJ_FILE_LIST) : %.obj : %.c
	$(CC) $(CFLAGS) $(OS_CFLAGS) $(INCLUDE_PATH) $(PROJECT_PATH) $(FC) /Fo$(SCRAP_DIR)/$@ /Fd$(SCRAP_DIR)/vc60.pdb $(filter %/$(notdir $<),$(C_FILE_LIST_AFTER_EXCLUDE))
