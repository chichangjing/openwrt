#
# Make definitions for Workbench26
#
...
WORKBENCH_TOOL_INCLUDE = $(FIS)C:/Workbench_2.6/vxworks-6.5/target/h/wrn/coreip$(FIE) \
		   $(FIS)C:/Workbench_2.6/vxworks-6.5/target/h/types$(FIE) \
		   $(FIS)C:/Workbench_2.6/vxworks-6.5/target/h/arch/ppc$(FIE)
...
ifeq (workbench, $(TOOL_ENV))
  OS_CFLAGS+= -I$(WIND_HOME)\components\ip_net2-6.5\ipcom\config
endif
