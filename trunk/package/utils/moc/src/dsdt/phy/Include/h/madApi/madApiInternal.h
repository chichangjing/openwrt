...
#define MAD_DEV_IS_IN_SWITCH(dev)   (dev->phyInfo.swPhyType)
...
#define MAD_IS_PORT_SET(_portVec, _port)    \
            ((_portVec) & (0x1 << (_port)))


#define MAD_LPORT_2_PORT(_lport)      mad_lport2port(dev->validPortVec, _lport)
#define MAD_PORT_2_LPORT(_port)       mad_port2lport(dev->validPortVec, _port)
