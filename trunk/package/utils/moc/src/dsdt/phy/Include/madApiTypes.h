...
extern MAD_U8 madLong2Char(MAD_U32 data);
extern unsigned char madShort2Char(unsigned short data);
extern unsigned short madLong2Short(unsigned int data);
extern unsigned long madLonglong2Long(unsigned long long data);
