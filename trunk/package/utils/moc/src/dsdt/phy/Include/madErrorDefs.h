...
#define MAD_DRV_FAIL_READ_PAGED_REG    0x5<<8    /*SMI Paged register Read failed */
...
#define MAD_API_WOL_NOT_SUPPORT        0x2c<<16 /*WOL not supported. */
...
#define MAD_API_SYNCE_BAD_PARAM            0x4a<<16 /*Set SyncE bad parameters. */
#define MAD_PHY_XMDIO_NOT_SUPPORT            0x4c<<16 /*XMDIO features not supported. */
...
#define MAD_API_EEE_LPI_NOT_SUPPORT    0x7b<<16 /*Set EEE power down not supported. */
#define MAD_API_EEE_MECSEC_LPI_NOT_SUPPORT    0x7c<<16 /*Set EEE Macsec power down not supported. */
#define MAD_API_QSGMII_NOT_SUPPORT        0x7d<<16    /*QSGMII not supported. */

#define MAD_API_FIBER_NOT_SUPPORT        0x81<<16    /* Fiber not supported. */
#define MAD_API_PHY_IN_SWITCH            0x82<<16    /* Thphy is part of Marvell switch. */
