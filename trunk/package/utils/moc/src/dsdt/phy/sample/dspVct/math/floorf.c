...
#ifdef ANSIC
float mvl_floorf(float);
#else
float mvl_floorf();
#endif

#ifdef ANSIC
float mvl_ceilf( float x )
#else
float mvl_ceilf(x)
double x;
#endif
...
#ifdef ANSIC
float mvl_frexpf( float x, int *pw2 )
#else
float mvl_frexpf( x, pw2 )
double x;
int *pw2;
#endif
{
...
#ifdef ANSIC
float mvl_ldexpf( float x, int pw2 )
#else
float mvl_ldexpf( x, pw2 )
double x;
int pw2;
#endif
{
