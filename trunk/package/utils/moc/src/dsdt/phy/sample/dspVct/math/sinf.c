...
static double FOPI = 1.27323954473516;

extern double PIO4F;
/* Note, these constants are for a 32-bit significand: */
/*
static double DP1 =  0.7853851318359375;
static double DP2 =  1.30315311253070831298828125e-5;
static double DP3 =  3.03855025325309630e-11;
static double lossth = 65536.;
*/

/* These are for a 24-bit significand: */
static double DP1 = 0.78515625;
static double DP2 = 2.4187564849853515625e-4;
static double DP3 = 3.77489497744594108e-8;
static double lossth = 8192.;
static double T24M1 = 16777215.;
...
y = FOPI * x; /* integer part of x/(PI/4) */
j = (unsigned long)y;
/* map zeros to origin */
if( j & 1 )
	{
...
y = FOPI * x; /* integer part of x/PIO4 */
j = (int)y;
