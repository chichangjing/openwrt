...
/* MAD error status API level 0 */
    switch(status&MAD_ERR_ST_API_0_MASK)
    {
        ...
        case MAD_API_DETECT_PW_DW_NOT_SUPPORT    :            
            ...
            break;
        case MAD_API_EEE_LPI_NOT_SUPPORT    :            
            MSG_PRINT(("EEE LPI mode not supported. \n"));    
            break;
        case MAD_API_EEE_MECSEC_LPI_NOT_SUPPORT    :            
            MSG_PRINT(("EEE Macsec LPI mode not supported. \n"));    
            break;
        case MAD_API_QSGMII_NOT_SUPPORT    :            
            MSG_PRINT(("QSGMII mode not supported. \n"));    
            break;
        case MAD_API_WOL_NOT_SUPPORT    :            
            MSG_PRINT(("WOL not supported. \n"));    
            break;
        ...
        case MAD_PHY_XMDIO_CAPABLE    :            
            MSG_PRINT(("XMDIO features not supported. \n"));    
            break;
