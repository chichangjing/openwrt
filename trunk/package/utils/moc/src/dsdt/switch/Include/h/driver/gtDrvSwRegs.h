...
#define QD_REG_PCS_CONTROL          0x1             /* for Sapphire family control */
#define QD_REG_PHY_CONTROL          0x1             /* for Physical control */
...
/* After Opus */
#define QD_REG_FLOW_CONTROL        0x2
#define QD_REG_IP_PRI_MAPPING      0x17
#define QD_REG_IEEE_PRI_MAPPING    0x18
#define QD_REG_PORT_CONTROL_3      0x19
#define QD_REG_QUEUE_CONTROL       0x1D
#define QD_REG_QUEUE_CONTROL_1     0x1C


#define QD_REG_HIDDEN_REG_ACCESS   0x1A
...
#define QD_REG_CORETAG_TYPE         0x19        /* for Ruby family and later*/
#define QD_REG_IP_MAPPING_TABLE     0x19        /* for Amber family and later */
#define QD_REG_MONITOR_CONTROL      0x1A        /* for Ruby family and later */
#define QD_REG_MANGEMENT_CONTROL    0x1A    /* for Schooner family and later */
#define QD_REG_TOTAL_FREE_COUNTER   0x1B    /* for Schooner family and later */
#define QD_REG_GLOBAL_CONTROL2      0x1C    /* for Sapphire, Schooner family and later */
...
#define QD_REG_ENERGE_MNT        0x12
#define QD_REG_IMP_COMM_DEBUG    0x13
...
#define QD_REG_CUT_THROU_CTRL    0x1F
...
#define QD_REG_TCAM_P2_DEBUG_PORT      0x1C              /* location is 0x1c in page 2 */
#define QD_REG_TCAM_P2_ALL_HIT         0x1F              /* location is 0x1f in page 2 */

#define QD_REG_TCAM_P3_EG_ACTION_1        0x2
#define QD_REG_TCAM_P3_EG_ACTION_2        0x3
#define QD_REG_TCAM_P3_EG_ACTION_3        0x4
...
#define QD_SERDES_CONTROL_REG            0
#define QD_SERDES_AUTONEGO_AD_REG            4
#define QD_SERDES_NEXTPAGE_TX_REG            7
#define QD_SERDES_AUTONEGO_1000AD_REG        9
#define QD_SERDES_SPEC_CONTROL_REG            16
#define QD_SERDES_INT_ENABLE_REG            18
#define QD_SERDES_INT_STATUS_REG            19
#define QD_SERDES_INT_PORT_SUMMARY_REG        20
...
#define QD_SERDES_RESET            0x8000
#define QD_SERDES_LOOPBACK            0x4000
#define QD_SERDES_SPEED            0x2000
#define QD_SERDES_AUTONEGO            0x1000
#define QD_SERDES_POWER            0x800
#define QD_SERDES_ISOLATE            0x400
#define QD_SERDES_RESTART_AUTONEGO        0x200
#define QD_SERDES_DUPLEX            0x100
#define QD_SERDES_SPEED_MSB        0x40
#define QD_SERDES_POWER_BIT            11
#define QD_SERDES_RESTART_AUTONEGO_BIT        9
...
#define QD_SMI_FUNC_INTERNAL       0x00
#define QD_SMI_FUNC_EXTERNAL       0x01
#define QD_SMI_FUNC_SETUP          0x02

/* Switch Mac/Wol/Wof definitions */
/* pointer for Agate and Pearl and Opus*/
#define GT_MAC_WOF_MAC_ADDRESS          0
#define GT_WOF_INT_SOURCE               0xc   /* Agate and Pearl */
#define GT_WOF_INT_SOURCE_1             0x8   /* Opus */
#define GT_WOF_INT_ENABLE               0xe   /* Agate and Pearl */
#define GT_WOF_INT_ENABLE_1             0xc   /* Opus */
#define GT_WOL_MAC_ADDRESS              0x10
#define GT_WOL_MAC_PASS                 0x16
#define GT_WOL_CONTROL                  0x1C  /* Agate and Pearl */
#define GT_WOL_CONTROL2                 0x1E  /* Agate and Pearl and Opus */
#define GT_WAKE_INT_SOURCE              0x1F  /* Agate and Pearl and Opus */
#define GT_WOL_CONTROL_1                0x20  /* Opus */
#define GT_MAC_GENNERAC                 0x2E  /* Opus */
