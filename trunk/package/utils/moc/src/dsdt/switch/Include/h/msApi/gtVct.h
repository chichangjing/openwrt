...
#define DEV_SPINNAKERB1  0x1B <<4    /*88E6071 B1 internal phy*/
...
#define DEV_SERDES_P5    0x24 << 4    /* 88E6352 (Agate) internal serdes port 5, 88E1540 */
...
#else
#define FORMULA_PHY100M(_data)    (((GT_32)(_data)*7861 - 188620)/10000 + (((((GT_32)(_data)*7861 - 188620)%10000) >= 5000)?1:0))
#define FORMULA_PHY1000M(_data)    (((GT_32)(_data)*8018 - 287510)/10000 + (((((GT_32)(_data)*8018 - 287510)%10000) >= 5000)?1:0))
#endif

#define GT_ADV_VCT_CALC(_data)        \
        (((GT_32)(_data)*8333 - 191667)/10000 + (((((GT_32)(_data)*8333 - 191667)%10000) >= 5000)?1:0))

#define GT_ADV_VCT_CALC_SHORT(_data)        \
        (((GT_32)(_data)*7143 - 71429)/10000 + (((((GT_32)(_data)*7143 - 71429)%10000) >= 5000)?1:0)) 
