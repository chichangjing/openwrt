...
)
{
    ...
    DBG_INFO(("gprtSetPause_mad Called.\n"));
...
)
{
    ...
    DBG_INFO(("gprtSetDTEDetect_mad Called.\n"));
...
)
{
    ...
    DBG_INFO(("gprtSetDTEDetectDropWait_mad Called.\n"));
...
)
{
    ...
    DBG_INFO(("gprtGetDTEDetectDropWait_mad Called.\n"));
