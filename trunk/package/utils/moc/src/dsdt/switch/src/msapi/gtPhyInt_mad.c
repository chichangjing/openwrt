...
* logical port number.
* For 88E6161 88E6165 devices, Serdes port 5 (address 0xD) can be accessed
* using logical port number, but not port 4 (since port 4 could be an internal PHY.)
* For 88E6352 devices, Serdes port 4/5 (address 0xF) can be accessed using logical port number.
* For 88E6321 devices, Serdes port 1/2 (address 0xC/0xD) can be accessed using logical port number.
*******************************************************************************/
