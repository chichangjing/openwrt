...
)
{
    ...
    switch (cfg)
    {
		case GT_LED_CFG_GLOBAL_CONTROL:
			ptr = 0;
			mask = 0x071F;
			break;
        ...
        case GT_LED_CFG_LED2: 
            if (IS_IN_DEV_GROUP(dev,DEV_LED_CFG_1))
			{
              return GT_BAD_PARAM;
			}
            ptr = 1;
        ...
        case GT_LED_CFG_LED3: 
            ...
            mask = 0xF0;
            break;
		case GT_LED_CFG_SPECIAL_LED1:
			if (!IS_IN_DEV_GROUP(dev,DEV_LED_CFG_2))
			{
              return GT_BAD_PARAM;
			}
			ptr = 1;
