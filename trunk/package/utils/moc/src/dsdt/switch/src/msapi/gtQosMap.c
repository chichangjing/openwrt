...
)
{
    ...
    DBG_INFO(("gqosSetForceQPri Called.\n"));
...
)
{
    ...
    DBG_INFO(("gqosGetForceQPri Called.\n"));
...
)
{
	...
	if (IS_IN_DEV_GROUP(dev,DEV_88E6065_FAMILY))
		retVal = hwSetPortRegField(dev,hwPort, QD_REG_PORT_CONTROL2,13,1,data);
	else
		retVal = hwSetPortRegField(dev,hwPort, QD_REG_PRI_OVERRIDE,12,1,data);
...
)
{
	...
	if (IS_IN_DEV_GROUP(dev,DEV_88E6065_FAMILY))
		...
		retVal = hwGetPortRegField(dev,hwPort, QD_REG_PRI_OVERRIDE,12,1,&data);
...
)
{
	...
	if (IS_IN_DEV_GROUP(dev,DEV_88E6065_FAMILY))
		...
		retVal = hwSetPortRegField(dev,hwPort, QD_REG_PRI_OVERRIDE,14,1,data);
...
)
{
	...
	if (IS_IN_DEV_GROUP(dev,DEV_88E6065_FAMILY))
		...
		retVal = hwGetPortRegField(dev,hwPort, QD_REG_PRI_OVERRIDE,14,1,&data);
...
)
{
    ...
    DBG_INFO(("gqosSetVTUQPriOverride Called.\n"));
    ...
    /* Set the VTUQPriOverride mode. */
	retVal = hwSetPortRegField(dev,hwPort, QD_REG_PRI_OVERRIDE,11,1,data);
...
)
{
    ...
    DBG_INFO(("gqosGetVTUQPriOverride Called.\n"));
    ...
    /* Get the DAFPriOverride mode. */
	retVal = hwGetPortRegField(dev,hwPort, QD_REG_PRI_OVERRIDE,11,1,&data);
...
)
{
    ...
    DBG_INFO(("gqosSetVTUFPriOverride Called.\n"));
    ...
    /* Set the VTUFPriOverride mode. */
	retVal = hwSetPortRegField(dev,hwPort, QD_REG_PRI_OVERRIDE,10,1,data);
...
)
{
    ...
    DBG_INFO(("gqosGetVTUFPriOverride Called.\n"));
    ...
    /* Get the DAFPriOverride mode. */
	retVal = hwGetPortRegField(dev,hwPort, QD_REG_PRI_OVERRIDE,10,1,&data);
...
)
{
	...
	if (IS_IN_DEV_GROUP(dev,DEV_88E6065_FAMILY))
		...
		retVal = hwSetPortRegField(dev,hwPort, QD_REG_PRI_OVERRIDE,13,1,data);
...
)
{
	...
	if (IS_IN_DEV_GROUP(dev,DEV_88E6065_FAMILY))
		...
		retVal = hwGetPortRegField(dev,hwPort, QD_REG_PRI_OVERRIDE,13,1,&data);
...
)
{
	...
	if (IS_IN_DEV_GROUP(dev,DEV_88E6065_FAMILY))
		...
		retVal = hwSetPortRegField(dev,hwPort, QD_REG_PRI_OVERRIDE,15,1,data);
...
)
{
	...
	if (IS_IN_DEV_GROUP(dev,DEV_88E6065_FAMILY))
		...
		retVal = hwGetPortRegField(dev,hwPort, QD_REG_PRI_OVERRIDE,15,1,&data);
