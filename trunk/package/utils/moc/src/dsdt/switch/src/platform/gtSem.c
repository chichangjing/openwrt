...
{
    if(dev->semCreate)
        return dev->semCreate(smid, state);

    return GT_OK; /* should return any value other than 0 to let it keep going */
}
