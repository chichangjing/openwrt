 ...
 * and by parameters of the Bridge stored in <91>Port 0<92>. This removes the
 * need for any <91>per Bridge<92> specification elements, and helps ensure
 ...
 * numbers of Bridge Ports. This shift of focus to <91>per Port operation<92>
